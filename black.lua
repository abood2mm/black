...
local UserId_Info = LuaTele.searchPublicChat("Eh_55")
...
local TestText = "  ‹ أيهاب . . \n⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n ‹ : *Dev Name* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n‹ : *Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/Eh_55"}
},
{
{text = '‹ أيهاب . . ', url='https://t.me/ZMstor'},
},
}
...
{
{text = '𝗎𝗉𝖽𝖺𝗍𝖾𝗌', url = 'https://t.me/ZMstor'},{text = '. ‹ EHAB 𝖳𝖾𝖺𝗆 ', url = 'https://t.me/ZMstor'}, 
},
{
{text = 'مبࢪمج اݪسوࢪس', url = 't.me/Eh_55'}, 
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/ZMstor&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
